...
export const SpeakerCard = ({ speaker, index }) => {
    return (
        ...
        >
            {/* Hover glow efekti */}
            <div className="absolute -inset-1 bg-gradient-to-r from-gray-400 via-gray-200 to-gray-300 dark:from-gray-500 dark:via-gray-200 dark:to-gray-300 rounded-2xl opacity-0 group-hover:opacity-30 blur-xl transition-all duration-500"></div>
            ...
            <div className="relative bg-gradient-to-br from-white via-gray-100 to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700/50 group-hover:border-gray-400 dark:group-hover:border-gray-400 transition-all duration-500 hover:shadow-2xl hover:shadow-gray-400/10 dark:hover:shadow-gray-100/20">
                ...
                {/* Üstte ince şerit */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-gray-400 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                {/* Görsel kısmı */}
                <div className="relative h-72 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-gray-900/60 dark:to-gray-900 z-10"></div>
                    ...
                    {/* Sağ üst efekt */}
                    <div className="absolute top-4 right-4 z-20 bg-gradient-to-br from-gray-200 to-gray-400 dark:from-gray-500 dark:to-gray-800 p-3 rounded-xl shadow-lg transform transition-all duration-500 group-hover:rotate-12 group-hover:scale-110">
                ...
                <div className="relative p-6 space-y-4">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            <div className="w-1 h-4 bg-gradient-to-b from-gray-400 to-gray-600 dark:from-gray-300 dark:to-gray-500 rounded-full"></div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {speaker.expertise.map((exp, i) => (
                            <span key={i} className="relative group/tag">
                                ...
                                <span className="absolute inset-0 bg-gradient-to-r from-gray-300 to-gray-400 dark:from-gray-200 dark:to-gray-300 rounded-lg opacity-0 group-hover/tag:opacity-100 transition-opacity duration-300"></span>
                            </span>
                        ))}
                    </div>
                </div>
                ...
                {/* Alt kavisli süs */}
                <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-gray-300 to-transparent dark:from-gray-700 dark:to-transparent rounded-tl-full transform translate-x-12 translate-y-12 group-hover:translate-x-8 group-hover:translate-y-8 transition-transform duration-500"></div>
            </div>
