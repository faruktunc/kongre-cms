...
function AnnouncementCard({ announcement }) {
    ...
    return (
        <article
            ...
            className="cursor-pointer rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-200 hover:shadow-md dark:border-gray-700 dark:bg-gray-900 dark:hover:border-red-800"
        >
...
export default function HomeAnnouncementsSection() {
    ...
    if (!loading && announcements.length === 0 && page === 1) {
        return null;
    }
                ...
                {loading ? (
                    <div className="space-y-4">
                        {[0, 1, 2].map((item) => (
                            <div
                                key={item}
                                className="h-36 animate-pulse rounded-xl bg-white/80 dark:bg-gray-900"
                            />
                        ))}
                    </div>
                ) : (
